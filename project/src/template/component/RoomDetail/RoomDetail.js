...
const data = [
  {
    title: 'Địa chỉ',
    content: '',
    avt: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzpQ5YenVypFBtbZCXd2pW5euFnknS_sBc_qh-0b-02HPC6XX2rOS5c0k_0MkCdY_LGNs&usqp=CAU',
  },
  {
    title: 'Diện tích',
    content: ' m2',
    avt: 'https://cdn3.iconfinder.com/data/icons/real-estate-flat-icons-vol-2/256/68-512.png',
  },
  {
    title: 'Giá',
    content: '  VND',
    avt: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFO-CSGZKlqR5nGD1wTguWPd0r0roaRt5Pr4ONom-UBJlvvJdq1a9VQC_JR-H_f_On8uY&usqp=CAU',
  },
  {
    title: 'Chủ trọ',
